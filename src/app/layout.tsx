...
export const metadata: Metadata = {
  title: "Brandify - Premium Marketing Agency for Brand Growth",
  description: "Strategic marketing agency delivering innovative campaigns that drive growth, engagement, and lasting brand impact. Transform your market presence today.",
  keywords: "marketing agency, brand strategy, digital marketing, social media marketing, content creation, advertising",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Brandify - Premium Marketing Agency",
    description: "Strategic marketing solutions that drive growth and transform your brand. Work with award-winning creatives.",
    type: "website",
    siteName: "Brandify",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766025223202-ief7q3j5.jpg",
      alt: "Brandify Marketing Agency"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Brandify - Marketing Agency",
    description: "Transform your brand into a market leader with strategic marketing expertise",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766025223202-ief7q3j5.jpg"]
  }
};
